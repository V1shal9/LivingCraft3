...
<div class=" per1">
		 ...
		 <div class=" cart-items">
		  ...
		  <ul class="cart-header"  ng-repeat="p in jsonData">
		   <div class="close1"> </div>
			...
			<li> <a href="checkout?userId=${sessionScope.userId }" class="add-cart cart-check">Check Out</a></li>
			<div class="clearfix"> </div>
			</ul>
 <ul class=" cart-header1">
		   <div class="close2"> </div>
			...
			<li><span>$ 60.00</span></li>
			<li><span>In Stock</span></li>
			<li> <a href="checkout?userId=${sessionScope.userId }" class="add-cart cart-check">ADD TO CART</a></li>
			<div class="clearfix"> </div>
			</ul>
		</div>
			 </div>
